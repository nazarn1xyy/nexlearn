...
export default function EditTestPage() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const [coursesRes, testRes] = await Promise.all([
          api.get('/api/courses/'),
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      setError('Помилка оновлення тесту');
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <Breadcrumbs items={[
        ...
        { label: 'Редагувати тест' },
      ]} />
      
      <h1 className="text-2xl font-bold mb-6">Редагувати тест</h1>
